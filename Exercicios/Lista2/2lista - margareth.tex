...
%TCIDATA{Created=Fri Jul 26 16:07:58 2002}
%TCIDATA{LastRevised=Tue Aug 19 16:40:22 2003}
%TCIDATA{<META NAME="GraphicsSave" CONTENT="32">}
%TCIDATA{<META NAME="DocumentShell" CONTENT="Exams and Syllabi\Syllabus">}
%TCIDATA{Language=American English}
%TCIDATA{CSTFile=Blue Homework.cst}
%TCIDATA{PageSetup=54,54,54,54,0}


\setcounter{secnumdepth}{0} \setlength{\topmargin}{-0.7cm}
\setlength{\headsep}{-0.5cm} \setlength{\textwidth}{17.5cm}
\setlength{\textheight}{25cm} \setlength{\oddsidemargin}{-1cm}
...
%%%% Preamble introduced by the authors
...
%%%% End of preamble introduced by the authors

%\includegraphics{C:/cabecalho.bmp}\\

\noindent

\begin{center}
{\large{\bf  UNIVERSIDADE FEDERAL DE VIÇOSA}

{\bf Centro de Ciências Exatas}

{\bf Departamento de Matemática}}

\bigskip

\underline{\underline{{\large{\bf$2^a$ Lista - MAT 137 -
Introdução à Álgebra Linear} \qquad \qquad \qquad \qquad
}\bf{II/2004}}}}
